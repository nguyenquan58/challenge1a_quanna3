...
CREATE TABLE `assign_submit` (
  ...
  `idassgin` varchar(10) NOT NULL,
  `id_sv` varchar(45) NOT NULL,
...
LOCK TABLES `assign_submit` WRITE;
/*!40000 ALTER TABLE `assign_submit` DISABLE KEYS */;
/*!40000 ALTER TABLE `assign_submit` ENABLE KEYS */;
UNLOCK TABLES;
